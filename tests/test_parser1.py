...
class TestExpressions:
    ...
    def test_string_formatting2(self):
        ...
        assert py2jslight("'hi %i %+i' % (a, b)") == py2jslight(
            "'hi {:i} {:+i}'.format(a, b)"
        )
        assert py2jslight("'hi %f %1.2f' % (a, b)") == py2jslight(
            "'hi {:f} {:1.2f}'.format(a, b)"
        )
        assert py2jslight("'hi %s %r' % (a, b)") == py2jslight(
            "'hi {} {!r}'.format(a, b)"
        )
        ...
        assert py2jslight("f'hi {a:f} {b:1.2f}'") == py2jslight(
            "'hi {:f} {:1.2f}'.format(a, b)"
        )
    ...
    def test_string_formatting3(self):
        ...
        assert (
            evalpy(x + "'hi {:f} {:1.0f} {:1.2f}'.format(a, a, a)")
            == "hi 3.141593 3 3.14"
        )
        assert (
            evalpy(x + "'hi {:05f} {:05.1f} {:+05.1f}'.format(a, a, a)")
            == "hi 3.141593 003.1 +03.1"
        )
        # g formatting, these outputs are (manually) validated with Python
        assert (
            evalpy(x + "'hi {:g} {:.1g} {:.3g}'.format(a, a, a)") == "hi 3.14159 3 3.14"
        )
        assert (
            evalpy(x + "'hi {:g} {:.1g} {:.3g}'.format(d, d, d)")
            == "hi 3.14159e+08 3e+08 3.14e+08"
        )
        assert (
            evalpy(x + "'hi {:g} {:.1g} {:.3g}'.format(e, e, e)")
            == "hi 0.00314159 0.003 0.00314"
        )
        assert (
            evalpy(x + "'hi {:05g} {:05.1g} {:+05.1g}'.format(a, a, a)")
            == "hi 3.14159 00003 +0003"
        )
